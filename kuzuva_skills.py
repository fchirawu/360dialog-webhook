...
SKILLS = [
    ...
    },
    {
        ...
        "guidance": (
            ...
            "needed, always say two things: (1) that you'll connect them with "
            "someone from the team, and (2) a brief, professional reason there "
            "may be a short wait -- vary the wording naturally each time "
            "rather than repeating the same sentence, choosing from reasons "
            "like: the relevant person is currently unavailable; or simply "
            "that it may take a little time to get back to them (no specific "
            "reason given). Example: 'I'll connect you with someone from our "
            "team who can help with that -- the relevant person is currently "
            "unavailable, so it may take a little time to get back to you.' "
            "Then, in the same message, ask if there's anything else you can "
            "help with in the meantime -- for example: 'In the meantime, is "
            "there anything else I can help you with?' Always include all "
            "three parts -- the handoff, the wait-time reason, and the "
            "meantime offer. Keep it generic and professional -- the customer "
            "should never learn a specific person's name or contact info from "
            "the bot."
        ),
    },
    {
